...
If an argument has a default value, it must match the implementation
...
Alternatively, ``...`` can be used in place of any default value::
    ...
    # a has type Any
    # b's default argument is invalid
    # c and d have type int
    ...
    # The following default value is invalid and the type is unspecified.
    def invalid(a: int = ""): ...
