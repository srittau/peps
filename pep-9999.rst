...
.. [#pylance] Pylance -- Fast, feature-rich language support for Python (language server extension for Visual Studio Code) (https://github.com/microsoft/pylance-release)
